...
import delphi.main.java.de.tudarmstadt.ukp.dkpro.statistics.agreement.AnnotationUnit;
 ...
 */
public class DelphiStudy extends AnnotationStudy 
	...
	public DelphiStudy(int raterCount) {
		this();
	...
	@Override
	public DelphiStudy clone() {
		DelphiStudy result = new DelphiStudy(getRaterCount());
	...
	public DelphiStudy stripCategories(final Object keepCategory, 
	...
	public DelphiStudy extractRaters(final int... raters) {
		DelphiStudy result = new DelphiStudy(raters.length);
		for (ICodingAnnotationItem item : getItems()) {
