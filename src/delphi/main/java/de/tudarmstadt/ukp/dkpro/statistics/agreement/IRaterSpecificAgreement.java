 ...
 * human rater. This is useful, for instance, to identify a certain rater
 * who potentially had problems with the interpretation of the annotation 
 * guidelines and thus created unreliable annotations with a low agreement to
 * all other raters.<br><br>
 * References:<ul>
